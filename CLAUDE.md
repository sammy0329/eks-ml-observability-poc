...
|------------|------|----------|----------|
| `main` | 배포 가능한 안정 브랜치 | — | — |
| `feature/phase{N}/epic{N}.{M}-{kebab-desc}` | 기능 개발 (Epic 단위) | main | main (PR) |
...
2. **브랜치 단위는 Epic** (`docs/TASKS.md`의 Epic ID와 연동). Task는 커밋 단위로 추적한다.
3. Epic 내 각 Task는 별도 커밋으로 기록하여 히스토리에서 추적 가능하게 한다.
4. 작업 완료 후 PR → main (squash merge 권장).
5. 브랜치명은 모두 소문자 kebab-case 사용.

### 브랜치명 예시

```
feature/phase1/epic1.1-프로젝트-초기화
feature/phase1/epic1.2-fastapi-추론-서비스
feature/phase2/epic2.1-센서-생성기
feature/phase2/epic2.2-도메인-메트릭-통합
feature/phase3/epic3.1-prometheus-alertmanager
feature/phase3/epic3.2-grafana-대시보드
feature/phase3/epic3.3-postgresql-이벤트-db
feature/phase3/epic3.4-로컬-통합-테스트
feature/phase4/epic4.1-eks-클러스터-ecr
feature/phase4/epic4.2-k8s-배포
feature/phase5/epic5.1-데모-시나리오
feature/phase5/epic5.2-산출물-정리
...
- **PR은 Epic 단위**로 생성. 포함된 Task ID 목록을 PR 본문에 명시한다.
